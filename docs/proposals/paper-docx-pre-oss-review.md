...
| --- | --- | --- | --- | --- |
| ~~Delete one comment and leave the rest~~ **Done.** | Review | Add, reply, resolve, or strip every comment. No single-comment delete. | `delete_comment` | **Not asked.** Original plan is add, reply, resolve only. |
